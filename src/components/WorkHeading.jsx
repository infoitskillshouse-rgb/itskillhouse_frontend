  ...
  return (
    ...
    >
      ...
      <div className="Home_div flex items-center justify-start gap-3">
       ...
       <FaArrowRight />
       <h1 className="text-[20px] font-medium ">Work</h1>
      </div>
      <h1 className="text-[3vw] leading-[6.5vw] lg:font-light  max-sm:font-light tracking-tight max-sm:text-[10vw] max-sm:leading-[12vw]">
      We don’t stop at  <span className="text-text text-[3.1vw] font-medium inline-block max-sm:text-[12vw] max-sm:font-light">
                creation
              </span> 
        <MagneticItem>
        </MagneticItem>
