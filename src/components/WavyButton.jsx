  ...
  return (
    <Link to="/contact">
      ...
      >
        ...
        <div
          className="relative z-10 w-16 h-16 text-center text-2xl rounded-full flex items-center justify-center shadow-xl mb-1 mr-1"
          data-cursor-hover
          data-cursor-hover-text="Hire Us"
        >
          👋
        </div>
      </button>
